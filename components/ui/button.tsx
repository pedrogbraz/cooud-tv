    ...
    variants: {
      variant: {
        default:
          ...
          blueLinks:
          "bg-gradient-to-b from-sky-400 via-sky-500 to-sky-600 shadow-md text-white",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-[--border-color] bg-background shadow-sm hover:border-[#999]/40 hover:text-accent-foreground",
        secondary:
